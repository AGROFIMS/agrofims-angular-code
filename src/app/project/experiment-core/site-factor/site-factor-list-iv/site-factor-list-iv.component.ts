...
@Component({
  selector: 'app-site-factor-list-iv',
  templateUrl: './site-factor-list-iv.component.html',
  styleUrls: ['./site-factor-list-iv.component.css']
})

export class SiteFactorListIvComponent implements OnInit, OnChanges {
